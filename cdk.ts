...
// Write CDK outputs to separate file to avoid overwriting .env.local
const envPath = path.join(__dirname, "apps/cms/.env.cdk.local");
const envContent = `# Auto-generated by CDK - DO NOT EDIT MANUALLY
# Import this in your .env.local if needed
# Last updated: ${new Date().toISOString()}

# AWS Cognito Configuration
VITE_COGNITO_REGION=${awsRegion}
VITE_COGNITO_CLIENT_ID=${apiStack.userPoolClient.userPoolClientId}

# tRPC API URL
VITE_API_URL=${apiStack.api.apiEndpoint}/api
`;

fs.writeFileSync(envPath, envContent, "utf-8");
console.log(`✅ Written CDK outputs to ${envPath}`);
