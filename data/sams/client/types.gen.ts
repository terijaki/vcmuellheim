...
import type { AddressZodType, AssociationResourcePageZodType, AssociationZodType, CommitteeMemberZodType, CommitteePageZodType, CommitteeZodType, CompetitionDtoZodType, CompetitionMatchDtoZodType, CompetitionMatchGroupDtoZodType, CompetitionMatchGroupPageZodType, CompetitionMatchGroupRankingsDtoZodType, CompetitionMatchPageZodType, CompetitionPageZodType, CompetitionRankingsResourcePageZodType, ConstraintViolationZodType, EmbeddedZodType, EventPageZodType, EventTypeZodType, EventZodType, HalRepresentationZodType, LeagueDtoZodType, LeagueHierarchyDtoZodType, LeagueHierarchyPageZodType, LeagueMatchDayDtoZodType, LeagueMatchDayPageZodType, LeagueMatchDtoZodType, LeagueMatchPageZodType, LeaguePageZodType, LeagueRankingsEntryDtoZodType, LeagueRankingsResourcePageZodType, LinkDtoZodType, LinksZodType, LocationResourcePageZodType, LocationZodType, MatchResultTypeCountZodType, ObjectZodType, RefereeTeamDtoZodType, ResponseExceptionMessageZodType, ResponseExceptionZodType, SeasonDtoZodType, SportsclubDtoZodType, SportsclubPageZodType, SuperCompetitionDtoZodType, SuperCompetitionPageZodType, TeamDtoZodType, TeamPageZodType, UserDetailsDtoZodType, ValidationErrorZodType, VolleyballMatchResultsDtoZodType, VolleyballMatchSetRestDtoZodType } from './zod.gen';
...
export type ValidationError = {
    violations?: Array<ConstraintViolationZodType>;
};
...
export type Association = {
    ...
    uuid: string;
    _links?: {
        [key: string]: LinkDtoZodType;
    } | null;
    _embedded?: {
        [key: string]: ObjectZodType;
    } | null;
    name: string;
...
export type AssociationResourcePage = {
    ...
    content?: Array<AssociationZodType>;
    empty?: boolean;
    totalPages?: number;
    first?: boolean;
    last?: boolean;
...
export type Committee = {
    ...
    members?: Array<CommitteeMemberZodType>;
    name?: string;
    shortname?: string;
    description?: string;
    type?: string;
...
export type CommitteePage = {
    ...
    content?: Array<CommitteeZodType>;
    empty?: boolean;
    totalPages?: number;
    first?: boolean;
    last?: boolean;
...
export type SportsclubPage = {
    ...
    content?: Array<SportsclubDtoZodType>;
    empty?: boolean;
    totalPages?: number;
    first?: boolean;
    last?: boolean;
...
export type LeagueHierarchyPage = {
    ...
    content?: Array<LeagueHierarchyDtoZodType>;
    empty?: boolean;
    totalPages?: number;
    first?: boolean;
    last?: boolean;
...
export type CompetitionPage = {
    ...
    content?: Array<CompetitionDtoZodType>;
    empty?: boolean;
    totalPages?: number;
    first?: boolean;
    last?: boolean;
...
export type LeaguePage = {
    ...
    content?: Array<LeagueDtoZodType>;
    empty?: boolean;
    totalPages?: number;
    first?: boolean;
    last?: boolean;
...
export type SuperCompetitionPage = {
    ...
    content?: Array<SuperCompetitionDtoZodType>;
    empty?: boolean;
    totalPages?: number;
    first?: boolean;
    last?: boolean;
...
export type CompetitionMatchGroupPage = {
    ...
    content?: Array<CompetitionMatchGroupDtoZodType>;
    empty?: boolean;
    totalPages?: number;
    first?: boolean;
    last?: boolean;
...
export type CompetitionMatchGroupRankingsDto = {
    ...
    rankings?: Array<LeagueRankingsEntryDtoZodType>;
};
...
export type CompetitionRankingsResourcePage = {
    ...
    content?: Array<CompetitionMatchGroupRankingsDtoZodType>;
    empty?: boolean;
    totalPages?: number;
    first?: boolean;
    last?: boolean;
...
export type LeagueRankingsEntryDto = {
    ...
    resultTypes?: Array<MatchResultTypeCountZodType> | null;
};
...
export type CompetitionMatchPage = {
    ...
    content?: Array<CompetitionMatchDtoZodType>;
    empty?: boolean;
    totalPages?: number;
    first?: boolean;
    last?: boolean;
...
export type VolleyballMatchResultsDto = {
    ...
    sets?: Array<VolleyballMatchSetRestDtoZodType> | null;
};
...
export type LeagueMatchDayPage = {
    ...
    content?: Array<LeagueMatchDayDtoZodType>;
    empty?: boolean;
    totalPages?: number;
    first?: boolean;
    last?: boolean;
...
export type LeagueRankingsResourcePage = {
    ...
    content?: Array<LeagueRankingsEntryDtoZodType>;
    empty?: boolean;
    totalPages?: number;
    first?: boolean;
    last?: boolean;
...
export type LeagueMatchPage = {
    ...
    content?: Array<LeagueMatchDtoZodType>;
    empty?: boolean;
    totalPages?: number;
    first?: boolean;
    last?: boolean;
...
export type GetAssociationsResponses = {
     ...
     * Successful operation
     */
    200: AssociationResourcePageZodType;
};
...
export type GetAllLeagueHierarchiesResponses = {
     ...
     * Successful operation
     */
    200: LeagueHierarchyPageZodType;
};
...
export type GetSuperCompetitionsByLeagueHierarchyResponses = {
     ...
     * Successful operation
     */
    200: SuperCompetitionPageZodType;
};
...
export type GetAllLocationsResponses = {
     ...
     * Successful operation
     */
    200: LocationResourcePageZodType;
};
...
export type GetMatchGroupsForCompetitionResponses = {
     ...
     * Successful operation
     */
    200: CompetitionMatchGroupPageZodType;
};
...
export type GetRankingsForCompetitionResponses = {
     ...
     * Successful operation
     */
    200: CompetitionRankingsResourcePageZodType;
};
...
export type GetAllCompetitionMatchesWithFilterResponses = {
     ...
     * Successful operation
     */
    200: CompetitionMatchPageZodType;
};
...
export type GetCompetitionMatchByUuidResponses = {
     ...
     * Successful operation
     */
    200: CompetitionMatchDtoZodType;
};
...
export type GetMatchGroupByUuidResponses = {
     ...
     * Successful operation
     */
    200: CompetitionMatchGroupDtoZodType;
};
...
export type GetRankingsForLeagueResponses = {
     ...
     * Successful operation
     */
    200: LeagueRankingsResourcePageZodType;
};
...
export type GetSuperCompetitionByUuidResponses = {
     ...
     * Successful operation
     */
    200: SuperCompetitionDtoZodType;
};
