...
const config: Config = {
	...
	theme: {
		extend: {
			...
			gridTemplateRows: {
				"news-card": "[top-start thumbnail-start] min(1px, 15rem) [heading-start] auto [thumbnail-end heading-end excerpt-start] 1fr [excerpt-end top-end]", // design for the news card to adjust dynamically depending on whether a thumbnail is present.
			},
			gridColumn: {
