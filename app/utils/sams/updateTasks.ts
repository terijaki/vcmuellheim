...
async function tasks() {
	const clubsObjects = await Bun.file(".temp/allClubs.json").json();

	const filteredClub = clubsObjects.filter((club: any) => club.name == SAMS_CLUB_NAME && club.internalSportsclubId == SAMS_CLUB_NUMBER);
