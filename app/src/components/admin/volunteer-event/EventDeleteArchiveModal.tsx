...
import { archiveVolunteerEventFn, deleteVolunteerEventFn, listVolunteerSignupsFn } from "@webapp/server/functions/volunteer";
import type { VolunteerEvent } from "@/lib/db/types";

export function EventDeleteArchiveModal({ opened, onClose, event, onDone }: { opened: boolean; onClose: () => void; event: VolunteerEvent | null; onDone: () => void }) {
