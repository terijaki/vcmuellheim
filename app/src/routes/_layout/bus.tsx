...
export const Route = createFileRoute("/_layout/bus")({
  loader: async () => {
    ...
    const bookings = (data.items || [])?.sort(
  ...
  return (
    <PageWithHeading title="Vereinsbus">
      <Container size="md">
        <Stack>
          <Alert variant="white">
            Die Verfügbarkeit des Vereinsbusses wird von mehreren Funktionären gemeinsam verwaltet.
                  ...
                  <Table.Tbody>
                    {bookingsFuture?.map((booking) => {
                      ...
                      const isSelected = selectedDates.some((d) => {
                        ...
                        return (
                          (selected.isSame(start, "date") || selected.isAfter(start, "date")) &&
                          (selected.isSame(end, "date") || selected.isBefore(end, "date"))
                        );
                      });
                      return (
                        <Table.Tr
