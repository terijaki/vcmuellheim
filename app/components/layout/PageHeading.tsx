	...
	return (
		...
		>
			...
			<div className="grid grid-cols-main-grid py-6 *:text-balance *:text-center">
				...
				<h1 className="text-white text-2xl md:text-3xl font-montserrat font-semibold col-center-content">{props.title}</h1>
				...
				{props.subtitle && !props.subtitleDate && <p className="col-center-content text-white text-sm font-thin mt-1">{props.subtitle}</p>}
			</div>
		</section>
	);
}
